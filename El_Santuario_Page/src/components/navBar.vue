<template>
    <nav class="w-full text-white"style="background-color: #141420;">
        <div class="w-[80%] mx-auto flex flex-row justify-between gap-x-4 py-3 ">
            ...
            <div class="w-1/3 justify-between md:justify-start content-center text-center">
                <h3 class="inter-subtitle-semi-bold  ">EL SANTUARIO</h3>
            </div>


            <!-- <div class="hidden md:flex w-2/3 justify-around"> -->
            <div class="flex w-2/3 justify-end md:justify-around">
                <button @click="isOpen = !isOpen"  class="inline xl:hidden text-3xl   justify-end">
                    ☰
                </button>
                <div class="hidden xl:flex flex-row gap-x-5 mx-5 justify-center content-center ">
                    <a class="inter-subtitle-regular   content-center" href="#">Inicio</a>
                    <a class="inter-subtitle-regular   content-center" href="#">Figuras</a>
                    <a class="inter-subtitle-regular   content-center" href="#">Ofertas</a>
                </div>
