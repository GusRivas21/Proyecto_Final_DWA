...
<template>
    <div class="bg-gray-900 min-h-screen pt-10 pb-10">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 justify-items-center mt-8">
                <div v-for="producto in paginatedProducts" :key="producto.id"
                    ...
                    <div class="w-full flex justify-between items-start mb-4 ">
                        ...
                        <div class="flex flex-col items-end">
                            <div class="flex items-center space-x-1 text-yellow-400 mb-1" role="img"
                                ...
                                <span aria-hidden="true" class="text-xl font-bold text-white block">{{ producto.rating
                                    }}</span>
                            </div>
                    ...
                    <button @click="agregarAlCarrito(producto)" :aria-label="`Agregar ${producto.nombre} al carrito`"
